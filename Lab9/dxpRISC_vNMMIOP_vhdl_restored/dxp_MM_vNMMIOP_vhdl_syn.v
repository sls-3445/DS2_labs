...
// ============================================================
// File Name: dxp_MM_vNMMIOP_vhdl.v
// Megafunction Name(s):
// 			altsyncram
//
...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="dxp_MM_vNMMIOP_P1.mif" NUMWORDS_A=1024 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=10 address_a clock0 data_a q_a wren_a
...
module  dxp_MM_vNMMIOP_vhdl_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_1.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_1.init_file_layout = "port_a",
		ram_block1a_1.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_1.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_2.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_2.init_file_layout = "port_a",
		ram_block1a_2.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_2.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_3.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_3.init_file_layout = "port_a",
		ram_block1a_3.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_3.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_4.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_4.init_file_layout = "port_a",
		ram_block1a_4.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_4.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_5.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_5.init_file_layout = "port_a",
		ram_block1a_5.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_5.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_6.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_6.init_file_layout = "port_a",
		ram_block1a_6.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_6.mem_init0 = 1024',
	...
	defparam
		...
		ram_block1a_7.init_file = "dxp_MM_vNMMIOP_P1.mif",
		ram_block1a_7.init_file_layout = "port_a",
		ram_block1a_7.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_7.mem_init0 = 1024',
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file dxp_MM_vNMMIOP_P1.mif is not of the dimensions 1024 X 8, the resulting memory design may not produce consistent simulation results.");
	end
endmodule //dxp_MM_vNMMIOP_vhdl_altsyncram
//VALID FILE
...
`endif
	...
	dxp_MM_vNMMIOP_vhdl_altsyncram	dxp_MM_vNMMIOP_vhdl_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl.vhd TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl_inst.vhd FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL dxp_MM_vNMMIOP_vhdl_syn.v TRUE
