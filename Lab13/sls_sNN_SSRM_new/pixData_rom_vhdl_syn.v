...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="dxp_sNN_testimages.mif" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
module  pixData_rom_vhdl_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "dxp_sNN_testimages.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 256'h00000000000000000000000000000000005400BA0155003801550054003800BA,
	...
	defparam
		...
		ram_block1a_1.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "dxp_sNN_testimages.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "dxp_sNN_testimages.mif",
...
endmodule //pixData_rom_vhdl_altsyncram
//VALID FILE
...
`endif
	...
	pixData_rom_vhdl_altsyncram	pixData_rom_vhdl_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
