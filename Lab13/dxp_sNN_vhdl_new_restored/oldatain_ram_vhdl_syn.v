...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=4 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=2 address_a clock0 data_a q_a wren_a
...
module  oldatain_ram_vhdl_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
endmodule //oldatain_ram_vhdl_altsyncram
//VALID FILE
...
`endif
	...
	oldatain_ram_vhdl_altsyncram	oldatain_ram_vhdl_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
