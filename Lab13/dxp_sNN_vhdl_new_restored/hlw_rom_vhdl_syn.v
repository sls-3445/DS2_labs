...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="w9_1.mif" NUMWORDS_A=16 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=4 address_a clock0 q_a
...
module  hlw_rom_vhdl_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "w9_1.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 16'h0038,
	...
	defparam
		...
		ram_block1a_1.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "w9_1.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "w9_1.mif",
...
endmodule //hlw_rom_vhdl_altsyncram
//VALID FILE
...
`endif
	...
	hlw_rom_vhdl_altsyncram	hlw_rom_vhdl_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
