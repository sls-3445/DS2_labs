...
// ============================================================
// File Name: dxp_16bit_signed_mult_vhdl.v
// Megafunction Name(s):
// 			lpm_mult
//
...
//lpm_mult DEVICE_FAMILY="Cyclone IV E" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=8 LPM_WIDTHB=8 LPM_WIDTHP=16 MAXIMIZE_SPEED=5 dataa datab result
...
module  dxp_16bit_signed_mult_vhdl_mult
	( 
	dataa,
	datab,
...
endmodule //dxp_16bit_signed_mult_vhdl_mult
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module dxp_16bit_signed_mult_vhdl (
	dataa,
	datab,
	result)/* synthesis synthesis_clearbox = 1 */;
	...
	dxp_16bit_signed_mult_vhdl_mult	dxp_16bit_signed_mult_vhdl_mult_component (
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
