...
//lpm_counter DEVICE_FAMILY="Cyclone IV E" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=4 clk_en clock q sclr
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = 1'b1;
endmodule //olAddrsCnt_vhdl_cntr
//VALID FILE
...
module olAddrsCnt_vhdl (
	...
	olAddrsCnt_vhdl_cntr	olAddrsCnt_vhdl_cntr_component (
				.clk_en (clk_en),
				.clock (clock),
				.sclr (sclr),
				.q (sub_wire0));
